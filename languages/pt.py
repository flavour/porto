...
'Entering an Organization is optional, but doing so directs you to the appropriate approver & means you automatically get the appropriate permissions.': 'Entering an Organization is optional, but doing so directs you to the appropriate approver & means you automatically get the appropriate permissions.',
...
'Portal at': 'Portal at',
'Porto Fire': 'Porto Fire',
'Porto Fire Management Platform': 'Porto Fire Management Platform',
...
'You are using the site-wide map configuration. To create or use a personal map configuration, click %(here)s': 'You are using the site-wide map configuration. To create or use a personal map configuration, click %(here)s',
...
'You can either use %(gravatar)s or else upload a picture here. The picture will be resized to 50x50.': 'You can either use %(gravatar)s or else upload a picture here. The picture will be resized to 50x50.',
